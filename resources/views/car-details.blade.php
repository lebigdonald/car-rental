            ...
            <section class="row row--grid">
                ...
                <div class="col-12 col-lg-5">
                    <div class="offer">
                        ...
                        <form id='rent-form' class="offer__list" action="{{ route('rent.store', ['id' => $car->id]) }}"
                              method="post">
                            @csrf
                            <ul class="offer__list">
                                <li>
                                    ...
                                    <div class="sign__group">
                                        <input type="date" id="start_date" name="start_date" class="sign__input"
                                ...
                                <li>
                                    ...
                                    <div class="sign__group">
                                        <input type="date" id="end_date" name="end_date" class="sign__input"
                                               placeholder="Jour de retour" required>
                                    </div>
                                </li>
                                <li>
                                    <span class="offer__list-name">Méthode de paiement </span>
                                    <div class="sign__group">
                                        <ul class="sign__radio">
                                            ...
                                            <li>
                                                <input id="type5" type="radio" value="Master Card"
                                                       name="payement_method">
                                                <label for="type5">Mastercard</label>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
